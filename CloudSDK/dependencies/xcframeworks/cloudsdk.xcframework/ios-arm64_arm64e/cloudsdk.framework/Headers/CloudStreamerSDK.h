...
-(void) putTimelineThumbnail:(UIImage*) img
                        date:(NSDate*) date;

-(void) putTimelineVideoSegment:(NSString*) segmentPath
...
-(void) getTimelineVideoSegment:(NSDate*) sdate
                        endDate:(NSDate*) edate
...
-(void) deleteTimelineVideoSegment:(NSDate*) sdate
                            endDate:(NSDate*) edate
                         onComplete:(void (^)(NSObject *, int)) complete;
