...
typedef NS_ENUM(int, CalendarApiProtocolDefaults) {
    CalendarApiProtocolDefaultsUNSECURE = 0,
    CalendarApiProtocolDefaultsSECURE = 1
};

typedef NS_ENUM(int, CalendarApiProtocolType) {
    CalendarApiProtocolTypeHTTP = 0,
    CalendarApiProtocolTypeHTTPS = 1
};
...
-(void) setCalendarApiPort:(int) port;
-(int) getCalendarApiPort;

-(void) setCalendarApiProtocolType:(CalendarApiProtocolType) type;
-(CalendarApiProtocolType) getCalendarApiProtocolType;

-(void) setCalendarApiProtocolDefaults:(CalendarApiProtocolDefaults) type;
