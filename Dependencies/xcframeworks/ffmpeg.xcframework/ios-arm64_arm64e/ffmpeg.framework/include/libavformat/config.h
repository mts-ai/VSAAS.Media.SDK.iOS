...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-version3 --enable-openssl --enable-pic --enable-hwaccels --enable-filters --enable-encoders --enable-muxers --disable-indevs --disable-outdevs --disable-asm --disable-indev=avfoundation --extra-cflags=' -arch arm64 -read_only_relocs suppress -miphoneos-version-min= -fno-unroll-loops -mios-simulator-version-min=13.0 -I/Users/vsaas/builds/hhjrhoXG/0/videoanalysis/vxg/mobile/ios/mediasdk/ffmpeg/ffmpeg/openssl/build/platforms/iossim_arm64/include' --extra-cxxflags=' -arch arm64 -read_only_relocs suppress -miphoneos-version-min= -fno-unroll-loops -mios-simulator-version-min=13.0' --extra-ldflags=' -arch arm64 -read_only_relocs suppress -miphoneos-version-min= -fno-unroll-loops -mios-simulator-version-min=13.0' --optflags=-O2 --prefix=/Users/vsaas/builds/hhjrhoXG/0/videoanalysis/vxg/mobile/ios/mediasdk/ffmpeg/ffmpeg/thin.libs/iossim_arm64"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/Users/vsaas/builds/hhjrhoXG/0/videoanalysis/vxg/mobile/ios/mediasdk/ffmpeg/ffmpeg/thin.libs/iossim_arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/vsaas/builds/hhjrhoXG/0/videoanalysis/vxg/mobile/ios/mediasdk/ffmpeg/ffmpeg/thin.libs/iossim_arm64/share/ffmpeg"
